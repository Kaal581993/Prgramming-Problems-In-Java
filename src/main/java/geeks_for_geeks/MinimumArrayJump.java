 ...
 * Output: 3
 * Explanation: First jump from 1st element to 2nd element with value 3. From here we jump
 * to 5th element with value 9, and from here we will jump to the last.
 *
